...
<?php endif; ?>
            ...
            <?php else: ?>
                <div class="hidden sm:flex sm:items-center sm:space-x-4 sm:ms-6">
                    <a href="<?php echo e(route('login')); ?>" class="text-sm font-medium text-gray-600 hover:text-gray-900">
                        <?php echo e(__('Log in')); ?>

                    </a>
                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="text-sm font-medium text-gray-600 hover:text-gray-900">
...
</nav><?php /**PATH C:\Users\lemue\Downloads\gestao-tarefas-main\gestao-tarefas-main\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>