  ...
  <div class="flex items-center justify-center min-h-screen bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
    <div class="w-full max-w-md bg-white shadow-2xl rounded-2xl overflow-hidden animate-fade-in">
      ...
      <div class="flex border-b border-gray-200">
        ...
        <a href="<?php echo e(route('register')); ?>" class="w-1/2 py-3 text-center text-gray-500 hover:text-indigo-600 font-semibold transition">
          Cadastro
        </a>
        <?php endif; ?>
      </div>
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
          ...
          <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-indigo-600 hover:underline">Esqueceu a senha?</a>
          </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\lemue\Downloads\gestao-tarefas-main\gestao-tarefas-main\resources\views/auth/login.blade.php ENDPATH**/ ?>