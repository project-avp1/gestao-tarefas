<nav class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <a href="<?php echo e(route('tarefas.index')); ?>"
                        class="nav-link <?php echo e(request()->routeIs('tarefas.*') ? 'active' : ''); ?>">
                        Minhas Tarefas
                    </a>
                </div>
            </div>
    ...
    <div id="mobile-menu" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <a href="<?php echo e(route('dashboard')); ?>"
                class="responsive-nav-link <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
                Dashboard
            </a>

            <a href="<?php echo e(route('tarefas.index')); ?>"
                class="responsive-nav-link <?php echo e(request()->routeIs('tarefas.*') ? 'active' : ''); ?>">
                Minhas Tarefas
            </a>
        </div>
    </div>
...
</style><?php /**PATH C:\xampp\htdocs\gestao-tarefas\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>